...
type CategoryServiceClient interface {
	...
	FindAllCategories(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*CategoryList, error)
	FindCategories(ctx context.Context, in *CategoryGetRequest, opts ...grpc.CallOption) (*CategoryResponse, error)
}
...
func (c *categoryServiceClient) FindAllCategories(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*CategoryList, error) {
	out := new(CategoryList)
	err := c.cc.Invoke(ctx, "/pb.CategoryService/findAllCategories", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *categoryServiceClient) FindCategories(ctx context.Context, in *CategoryGetRequest, opts ...grpc.CallOption) (*CategoryResponse, error) {
	out := new(CategoryResponse)
...
type CategoryServiceServer interface {
	...
	FindAllCategories(context.Context, *Blank) (*CategoryList, error)
	FindCategories(context.Context, *CategoryGetRequest) (*CategoryResponse, error)
...
func (UnimplementedCategoryServiceServer) FindAllCategories(context.Context, *Blank) (*CategoryList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindAllCategories not implemented")
}
func (UnimplementedCategoryServiceServer) FindCategories(context.Context, *CategoryGetRequest) (*CategoryResponse, error) {
...
func _CategoryService_FindAllCategories_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.CategoryService/findAllCategories",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).FindAllCategories(ctx, req.(*Blank))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _CategoryService_FindCategories_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).FindCategories(ctx, req.(*CategoryGetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
